...
@Messages(
    {
      "LBL_MacPages_LOADER=iWork Pages File"
    })
@MIMEResolver.ExtensionRegistration(
    displayName = "#LBL_MacPages_LOADER",
...
@DataObject.Registration(
    mimeType = "application/x-iwork-pages-sffpages",
    iconBase = "de/nigjo/nbm/office/filetypes/iwk/Pages_Flat.png",
    displayName = "#LBL_MacPages_LOADER",
    position = 384
)
@ActionReferences(
    {
      @ActionReference(
          path = "Loaders/application/x-iwork-pages-sffpages/Actions",
          id =
...
public class MacPagesDataObject extends MultiDataObject
{
  private static final long serialVersionUID = -6981586561927381772L;

  public MacPagesDataObject(FileObject pf, MultiFileLoader loader)
