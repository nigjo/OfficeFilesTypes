...
@Messages(
    {
      "LBL_MSPowerpoint_LOADER=Microsoft PowerPoint File"
    })
@MIMEResolver.ExtensionRegistration(
    displayName = "#LBL_MSPowerpoint_LOADER",
    mimeType = "application/x-mspowerpoint",
    extension =
    {
      "ppt", "pps", "ppa", "pptx", "ppsx", "ppam", "pptm", "ppsm"
    }
)
@DataObject.Registration(
    mimeType = "application/x-mspowerpoint",
    iconBase = "de/nigjo/nbm/office/filetypes/mso/powerpoint-file-icon.png",
    displayName = "#LBL_MSPowerpoint_LOADER",
    position = 388
)
@ActionReferences(
    {
      @ActionReference(
          path = "Loaders/application/x-mspowerpoint/Actions",
          id =
...
public class MSPowerPointDataObject extends MultiDataObject
{
  private static final long serialVersionUID = -6981586561927381772L;

  public MSPowerPointDataObject(FileObject pf, MultiFileLoader loader)
