...
@Messages(
    {
      "LBL_MSWord_LOADER=Microsoft Word File"
    })
@MIMEResolver.ExtensionRegistration(
    displayName = "#LBL_MSWord_LOADER",
...
@DataObject.Registration(
    mimeType = "application/x-msword",
    iconBase = "de/nigjo/nbm/office/filetypes/mso/word-file-icon.png",
    displayName = "#LBL_MSWord_LOADER",
    position = 380
)
@ActionReferences(
    {
      @ActionReference(
          path = "Loaders/application/x-msword/Actions",
          id =
...
public class MSWordDataObject extends MultiDataObject
{
  private static final long serialVersionUID = -6981586561927381772L;

  public MSWordDataObject(FileObject pf, MultiFileLoader loader)
